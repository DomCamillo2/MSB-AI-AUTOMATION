    ...
    <main id="main-content" className="page-shell">
      ...
      <article className="container prose-panel legal-document">
        <header className="legal-header">
          ...
          <nav className="legal-toc" aria-label="Inhaltsverzeichnis Datenschutz">
            <p>Direkt zu</p>
            <ol>
              <li><a href="#verantwortlicher">Verantwortlicher</a></li>
              <li><a href="#hosting">Hosting &amp; IONOS WebAnalytics</a></li>
              <li><a href="#kontaktformular">Kontaktformular</a></li>
              <li><a href="#automation-check">Automation Check</a></li>
              <li><a href="#einwilligung">Einwilligung</a></li>
        ...
        <section id="verantwortlicher" aria-labelledby="controller-heading">
        ...
        <section id="hosting" aria-labelledby="hosting-heading">
          ...
          <p>
            Nach Angaben von IONOS sind Tracking und Logging für das zum Webhosting gehörende IONOS WebAnalytics standardmäßig aktiviert. Die Auswertung erfolgt per Logdatei oder Zählpixel ohne Cookies. Die beim Seitenaufruf übermittelte IP-Adresse wird von IONOS unmittelbar anonymisiert; ausgewertet werden die oben genannten technischen Zugriffsdaten zur statistischen Auswertung und technischen Optimierung des Webangebots. Soweit vor der Anonymisierung personenbezogene Daten verarbeitet werden, erfolgt dies auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO; unser berechtigtes Interesse liegt in einer datensparsamen Reichweitenmessung und der technischen Optimierung. Nach Angaben von IONOS werden keine personenbezogenen Besucherdaten gespeichert und keine Daten an Dritte weitergegeben.
          </p>
          <p>
            IONOS ist für die in unserem Auftrag erbrachten Hosting- und Kommunikationsleistungen als Auftragsverarbeiter nach Art. 28 DSGVO eingebunden. Weitere Informationen finden Sie in den <a href="https://www.ionos.de/hilfe/datenschutz/datenverarbeitung-durch-ihr-ionos-produktes/datenverarbeitung-durch-webhosting-produkte/" rel="noreferrer">Informationen zur Datenverarbeitung durch IONOS Webhosting</a>, den <a href="https://www.ionos.de/hilfe/datenschutz/datenverarbeitung-durch-ihr-ionos-produktes/webanalytics/" rel="noreferrer">Informationen zu IONOS WebAnalytics</a>, den <a href="https://www.ionos.de/hilfe/datenschutz/allgemeine-informationen-zur-datenschutz-grundverordnung-dsgvo/vereinbarung-zur-auftragsverarbeitung-avv-mit-ionos-abschliessen/" rel="noreferrer">Informationen zur Auftragsverarbeitung</a> und den <a href="https://www.ionos.de/terms-gtc/datenschutzerklaerung/" rel="noreferrer">Datenschutzhinweisen von IONOS</a>.
          </p>
        </section>

        <section id="kontaktformular" aria-labelledby="ionos-heading">
          <h2 id="ionos-heading">3. Kontaktformular und E-Mail</h2>
          <p>
            Wenn Sie das Kontaktformular absenden, werden die von Ihnen eingetragenen Angaben verschlüsselt an unseren Webspace übertragen und über den authentifizierten SMTP-Dienst von IONOS an <a href="mailto:kontakt@msb-ai.de">kontakt@msb-ai.de</a> zugestellt. Verarbeitet werden Name, Unternehmen, E-Mail-Adresse, optional eine Telefonnummer, Nachricht beziehungsweise Prozesseinschätzung, Bestätigungsstatus, Zeitpunkt und eine zufällige Anfragekennung. IONOS verarbeitet bei der Zustellung außerdem Absender- und Empfängeradresse, technische Zustelldaten und den Nachrichteninhalt.
          </p>
          <p>
            Nach erfolgreichem Versand erhalten Sie automatisch eine Eingangsbestätigung an Ihre E-Mail-Adresse. Sie enthält eine Kurzreferenz Ihrer Anfrage, den voraussichtlichen Rückmeldezeitraum und unsere Kontaktdaten. Die Bestätigung dient ausschließlich der transparenten Bearbeitung Ihrer Anfrage.
          </p>
          <p>
          ...
          <p>
            Zum Schutz vor automatisiertem Missbrauch verwendet das Formular ein unsichtbares Prüffeld, eine Mindestbearbeitungszeit und eine technische Begrenzung wiederholter Anfragen. Hierfür wird aus der anfragenden IP-Adresse ein pseudonymisierter Prüfwert gebildet und zusammen mit den Anfragezeitpunkten in einer temporären Datei des Webservers gespeichert. Für die Begrenzung werden ausschließlich Anfragezeitpunkte aus den jeweils letzten 15 Minuten berücksichtigt. Bei jeder neuen Formularübermittlung werden abgelaufene Anfragezeitpunkte und inaktive temporäre Dateien technisch bereinigt. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO; unser berechtigtes Interesse liegt im Schutz des Formulars und unseres Postfachs vor Spam und Angriffen.
          </p>
        </section>

        <section id="automation-check" aria-labelledby="contact-data-heading">
          ...
          <p>
            Erst nach der angezeigten Einschätzung können Sie freiwillig eine Übermittlung an MSB veranlassen. Nach Ihrer ausdrücklichen Bestätigung werden die strukturierten Antworten, ein optionaler Hinweis, optional eine lokal erzeugte PDF-Auswertung sowie die von Ihnen angegebenen Kontaktdaten über das Kontaktformular an unser IONOS-Postfach gesendet. Sie erhalten anschließend eine Eingangsbestätigung an Ihre E-Mail-Adresse mit einem Kurzüberblick der Einschätzung. Ohne diesen gesonderten Schritt bleiben die Antworten und die PDF ausschließlich in Ihrem Browser.
          </p>
          <p>
        ...
        <section id="einwilligung" aria-labelledby="consent-heading">
          <h2 id="consent-heading">5. Einwilligung und lokale Speicherung</h2>
          <p>
            Beim ersten Besuch können Sie Statistik zulassen, ablehnen oder Ihre Auswahl im Detail festlegen. Ohne Ihre ausdrückliche Einwilligung wird Google Analytics weder geladen noch kontaktiert. Ihre Entscheidung wird unter dem Schlüssel <code>msb_consent_v1</code> im lokalen Speicher Ihres Browsers abgelegt. Gespeichert werden die Version der Abfrage, Ihre Auswahl und der Zeitpunkt der Entscheidung. Die Auswahl bleibt bis zu ihrer Änderung, der Löschung der Website-Daten im Browser oder einer neuen Version unserer Einwilligungsabfrage gespeichert. Dies ist erforderlich, damit die Website Ihre Auswahl berücksichtigt und nicht bei jedem Aufruf erneut fragt.
          </p>
          <p>
        ...
        <section id="google-analytics" aria-labelledby="analytics-heading">
          ...
          <p>
            Wenn Sie Statistik ausdrücklich erlauben, verwenden wir Google Analytics 4 mit der Mess-ID <code>G-P2P7JJ6QV2</code>. Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Google Analytics hilft uns zu verstehen, welche Seiten genutzt und welche ausgewählten Handlungen ausgeführt werden. Erfasst werden Seitenpfad ohne URL-Suchparameter, Seitentitel, technische Geräte- und Browserinformationen sowie die Ereignisse „CTA-Klick“, „Automation Check begonnen“, „Schritt aufgerufen“, „Check abgeschlossen“, „Kontakt zum Ergebnis geöffnet“, „Ergebnis-PDF heruntergeladen“, „E-Mail-Link ausgewählt“, „Telefon-Link ausgewählt“ und „Kontaktanfrage abgesendet“. Bei Check-Ereignissen werden ausschließlich technische Bezeichner des Schritts beziehungsweise der Ergebniskategorie übertragen. Antworten, Auswahltexte, Notizen, E-Mail-Adressen und andere personenbezogene Angaben werden nicht an Google Analytics übermittelt.
          </p>
          <p>
            Google Analytics wird mit Einwilligungsmodus in einer datenschutzfreundlichen Grundeinstellung eingebunden. Vor Ihrer ausdrücklichen Freigabe bleiben Analyse-, Werbe- und Personalisierungs-Speicherung auf <code>denied</code>; Google Signals und personalisierte Werbung sind ebenfalls deaktiviert. Erst nach Ihrer Freigabe nutzen wir Analytics für reguläre Statistik-Messung. 
          </p>
          <p>
          ...
          <p>
            Nach Ihrer Einwilligung setzt Google Analytics die Cookies <code>_ga</code> und <code>_ga_&lt;Container-ID&gt;</code>, um Nutzende beziehungsweise Sitzungszustände zu unterscheiden. Wir begrenzen deren Laufzeit technisch auf höchstens zwölf Monate und verlängern sie bei weiteren Seitenaufrufen nicht. Die Aufbewahrung von Nutzer- und Ereignisdaten in der Google-Analytics-Property richtet sich nach der dort konfigurierten Aufbewahrungsfrist; aggregierte Standardberichte können hiervon unberührt bleiben.
          </p>
          <p>
        ...
        <section id="speicherdauer" aria-labelledby="retention-heading">
          <h2 id="retention-heading">9. Speicherdauer</h2>
          <p>
            Kontaktanfragen werden gelöscht, sobald ihre Bearbeitung abgeschlossen ist und keine vertraglichen oder gesetzlichen Gründe für eine weitere Aufbewahrung bestehen. Entsteht eine Geschäftsbeziehung, können geschäftliche Unterlagen entsprechend den handels- und steuerrechtlichen Aufbewahrungsfristen gespeichert werden. IONOS hält Webhosting-Besucherdaten nach eigener Angabe für acht Wochen vor. Anfragezeitpunkte des Missbrauchsschutzes wirken nur innerhalb eines 15-minütigen Prüfzeitraums; abgelaufene Zeitpunkte und inaktive temporäre Dateien werden bei der nächsten Formularübermittlung bereinigt. Google-Analytics-Cookies sind technisch auf höchstens zwölf Monate begrenzt. Die Speicherdauer von Google-Analytics-Nutzerdaten wird in der Analytics-Property festgelegt; ereignisbezogene Daten werden dort spätestens nach der konfigurierten Aufbewahrungsfrist gelöscht. Aggregierte Berichte können länger erhalten bleiben.
          </p>
        </section>

        <section id="rechte" aria-labelledby="rights-heading">
