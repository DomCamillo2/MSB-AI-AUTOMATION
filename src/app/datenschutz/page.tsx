    ...
    <main id="main-content" className="page-shell">
      <article className="container prose-panel legal-document">
        ...
        <section aria-labelledby="ionos-heading">
          ...
          <p>
            Zum Schutz vor automatisiertem Missbrauch verwendet das Formular ein unsichtbares Prüffeld, eine Mindestbearbeitungszeit und eine technische Begrenzung wiederholter Anfragen. Hierfür wird aus der anfragenden IP-Adresse ein pseudonymisierter Prüfwert gebildet und zusammen mit den Anfragezeitpunkten in einer temporären Datei des Webservers gespeichert. Für die Begrenzung werden ausschließlich Anfragezeitpunkte aus den jeweils letzten 15 Minuten berücksichtigt; ältere Einträge werden bei der nächsten Prüfung verworfen. Nicht mehr aktive temporäre Dateien werden bei späteren Formularaufrufen stichprobenartig bereinigt und können bis zu dieser technischen Bereinigung noch ohne wirksame Sperrinformation im temporären Verzeichnis verbleiben. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO; unser berechtigtes Interesse liegt im Schutz des Formulars und unseres Postfachs vor Spam und Angriffen.
          </p>
        </section>
